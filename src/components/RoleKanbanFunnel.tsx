                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      dropTargetStage === stage && draggedCandidate ? 'border-primary' : 'border-[hsl(var(--brand-border))]'
                    )}
                    onMouseDown={(e) => {
      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          <div
            ...
            onDragEnd={() => onDragEnd?.()}
            className={cn(
              "kanban-card bg-white rounded-md border-[0.5px] border-[hsl(var(--brand-border))] px-2 py-[7px] transition-all space-y-1.5 cursor-pointer hover:bg-[hsl(var(--brand-surface))]",
