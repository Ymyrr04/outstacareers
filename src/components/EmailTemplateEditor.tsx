...
const availableTriggers = [
  ...
  { value: 'talent_pool', label: 'Talent Pipeline' },
  { value: 'cold_talent_pool', label: 'Cold Talent Pool' },
                  ...
                  {loading ? (
                    ...
                    (() => {
                      ...
                      const pipelineOrder = [
                        ...
                        { key: 'talent_pool', label: 'Talent Pipeline' },
                        { key: 'cold_talent_pool', label: 'Cold Talent Pool' },
