              ...
              <Droppable droppableId={stage} key={stage}>
                {(provided, snapshot) => (
                  ...
                  >
                    ...
                    <div className={`kanban-column-body flex-1 flex flex-col gap-[5px] min-h-[300px] bg-white border-[0.5px] border-t-0 rounded-b-[7px] p-1.5 ${snapshot.isDraggingOver ? 'border-primary' : 'border-[hsl(var(--brand-border))]'}`}>
                          ...
                          {(p, s) => (
                            <div
                              ...
                              {...p.draggableProps}
                               ...
                               className={`kanban-card bg-white border-[0.5px] border-[hsl(var(--brand-border))] rounded-md px-2 py-[7px] cursor-pointer hover:bg-[hsl(var(--brand-surface))] transition ${s.isDragging ? 'rotate-1 shadow-lg' : ''}`}
