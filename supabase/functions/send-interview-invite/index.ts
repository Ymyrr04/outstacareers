...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #f5f5f5;">
  <table role="presentation" style="width: 100%; border-collapse: collapse;">
          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 30px 0 0 0;">
                Please confirm your attendance by replying to this email. If the scheduled time doesn't work for you, let us know and we'll find an alternative.
              </p>
              
              <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 20px 0 0 0;">
                Best regards,<br>
                <strong>${interviewerName}</strong><br>
                <span style="color: #666666;">Outsta Recruitment Team</span>
              </p>
            </td>
          </tr>
    ...
    await client.send({
      from: gmailUser,
      to: to,
      subject: `Interview Invitation - ${jobTitle} Position at Outsta`,
      content: "auto",
      html: emailHtml,
    });
    ...
    console.log("Interview invite sent successfully to:", to);
