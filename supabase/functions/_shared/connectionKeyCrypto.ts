// Server-only. Encrypts/decrypts per-user connector connection keys using
// APP_USER_CONNECTION_KEY_SECRET auto-provisioned by Lovable when an App User
// Connector is linked. Never import this from browser code.
